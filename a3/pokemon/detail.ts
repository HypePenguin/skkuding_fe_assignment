let storage_data  : string | null = localStorage.getItem("data");
let storage_pokeNum : string | null = localStorage.getItem("pokeNum");
let data : any;
if (storage_data) {
  data = JSON.parse(storage_data);
}
...
let link : string = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/" + pokeNum +".png";
